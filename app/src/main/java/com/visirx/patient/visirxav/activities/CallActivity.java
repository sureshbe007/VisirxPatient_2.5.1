...
import com.visirx.patient.visirxav.fragments.ConversationFragment;
import com.visirx.patient.visirxav.fragments.IncomeCallFragment;
import com.visirx.patient.visirxav.fragments.OnCallEventsController;
import com.visirx.patient.visirxav.fragments.OpponentsFragment;
import com.visirx.patient.visirxav.fragments.SessionController;
import com.visirx.patient.visirxav.holder.DataHolder;
import com.visirx.patient.visirxav.util.ChatPingAlarmManager;
import com.visirx.patient.visirxav.util.DialogUtil;
import com.visirx.patient.visirxav.util.FragmentExecuotr;
import com.visirx.patient.visirxav.util.NetworkConnectionChecker;
import com.visirx.patient.visirxav.util.RingtonePlayer;
import com.visirx.patient.visirxav.util.SettingsUtil;
...
public class CallActivity extends BaseLogginedUserActivity implements QBRTCClientSessionCallbacks,
        QBRTCSessionConnectionCallbacks, QBRTCSignalingCallback, OnCallEventsController, SessionController,
    ...
    private SessionController.QBRTCSessionUserCallback sessionUserCallback;
    ...
    public void addConversationFragmentStartCall(List<QBUser> opponents, QBRTCTypes.QBConferenceType qbConferenceType, Map<String, String> userInfo)
    {

        Log.d("CallActivity","addConversationFragmentStartCall()  ===opponents    :" +opponents);
        Log.d("CallActivity","addConversationFragmentStartCall()  ===qbConferenceType    :" +qbConferenceType);
        Log.d("CallActivity","addConversationFragmentStartCall()  ===userInfo    :" +userInfo);
    ...
    public void addConversationFragmentReceiveCall()
    {
        ...
        Log.d("CAllActivity","addConversationFragmentReceiveCall() :");
    ...
    private void setOptionsForSession(QBRTCSession session, SharedPreferences sharedPref){
        ...
        sessionOptions.closeIfInitiatorHangUp =  sharedPref.getBoolean(getString(R.string.pref_initiator_behaviour_key),
